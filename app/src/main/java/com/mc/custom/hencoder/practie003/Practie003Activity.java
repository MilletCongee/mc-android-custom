package com.mc.custom.hencoder.practie003;
 ...
 *   4.初始化
 */
public class Practie003Activity extends BaseActivity {
    TabLayout tabLayout;
    ViewPager pager;
    ...
    protected void initData(Bundle savedInstanceState) {
        pager.setAdapter(new FragmentPagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                ...
                return PractieViewFragment.newInstance(Practie003Activity.this,pageModel.practiceLayoutRes);
            }
